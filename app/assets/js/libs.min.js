 ...
 */
!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof exports?module.exports=e(require("jquery")):e(jQuery)}(function(e){function t(e){return c.raw?e:encodeURIComponent(e)}function n(e){return c.raw?e:decodeURIComponent(e)}function r(e){return t(c.json?JSON.stringify(e):e+"")}function o(e){0===e.indexOf('"')&&(e=e.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{return e=decodeURIComponent(e.replace(a," ")),c.json?JSON.parse(e):e}catch(t){}}function i(t,n){var r=c.raw?t:o(t);return e.isFunction(n)?n(r):r}var a=/\+/g,c=e.cookie=function(o,a,u){if(arguments.length>1&&!e.isFunction(a)){if(u=e.extend({},c.defaults,u),"number"==typeof u.expires){var s=u.expires,l=u.expires=new Date;l.setMilliseconds(l.getMilliseconds()+864e5*s)}return document.cookie=t(o)+"="+r(a)+(u.expires?"; expires="+u.expires.toUTCString():"")+(u.path?"; path="+u.path:"")+(u.domain?"; domain="+u.domain:"")+(u.secure?"; secure":"")}for(var d=o?void 0:{},f=document.cookie?document.cookie.split("; "):[],p=0,m=f.length;m>p;p++){var h=f[p].split("="),g=n(h.shift()),v=h.join("=");if(o===g){d=i(v,a);break}o||void 0===(v=i(v))||(d[g]=v)}return d};c.defaults={},e.removeCookie=function(t,n){return e.cookie(t,"",e.extend({},n,{expires:-1})),!e.cookie(t)}});
